  ...
  return (
     ...
     <div className="md:w-1/2 bg-blue-600 flex items-center justify-center p-8">
        <div className="max-w-md">
          <img 
            src="https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80" 
            alt="Professional login" 
            className="w-full h-auto rounded-lg shadow-xl"
          />
          <h2 className="text-white text-2xl font-bold mt-6">Welcome Back Professional</h2>
          <p className="text-blue-100 mt-2">
            Access your professional dashboard and continue your work.
          </p>
        </div>
      </div>
