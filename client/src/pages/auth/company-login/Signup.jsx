  ...
  return (
    <div className="md:w-1/2 bg-blue-600 flex items-center justify-center p-8">
        <div className="max-w-md">
          ...
          />
          <h2 className="text-white text-2xl font-bold mt-6">Join Our Professional Community</h2>
          <p className="text-blue-100 mt-2">
            Connect with other professionals and grow your network in your industry.
          </p>
        </div>
      </div>
  )
