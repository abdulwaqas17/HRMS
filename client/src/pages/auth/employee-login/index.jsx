    ...
    <div className="md:w-1/2 bg-indigo-700 flex items-center justify-center p-8">
      <div className="max-w-md">
        ...
        <p className="text-purple-100 mt-2">
          Configure system settings and manage all companie work.
        </p>
      </div>
    </div>
  );
...
const EmployeeLoginForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${import.meta.env.VITE_API_URL}/auth/login/employee`, {
...
export { EmployeeLoginImage, EmployeeLoginForm };
