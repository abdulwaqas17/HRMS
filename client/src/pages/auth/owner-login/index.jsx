...
const OwnerLoginImage = () => {
  ...
  <div className="max-w-md">
    <img 
      src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80" 
      alt="Company Owner login" 
      className="w-full h-auto rounded-lg shadow-xl"
    />
    <h2 className="text-white text-2xl font-bold mt-6">Business Owner Dashboard</h2>
    <p className="text-indigo-100 mt-2">
      Oversee your entire organization and track key business metrics.
    </p>
  </div>
</div>
